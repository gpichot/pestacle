...
export function TimelineItem(
  ...
  return (
    ...
    >
      <div className={styles.itemContentPhantom}>
        <div className={styles.itemTitle}>{title}</div>
        <div className={styles.itemBody}>{children}</div>
      </div>
      <animated.div className={styles.guide} style={colorStyles}>
        <Hexagon />
        <animated.div className={styles.guideLine} style={guideLineProps} />
      </animated.div>
